...
const Profile = () => {
  ...
  return ( 
  <>
  {whoiam.isAuthenticated &&  <section className="vh-100" style={{backgroundColor: '#f4f5f7'}}>
              ...
              <div className="card-body p-4">
                ...
                <div className="row pt-1">
                  <div className="col-6 mb-3">
                    <h6>Email</h6>
                    <p className="text-muted">{whoiam.user.email}</p>
                  </div>
                  <div className="col-6 mb-3">
                    <h6>Phone</h6>
                    <p className="text-muted">{whoiam.user.phone}</p>
                  </div>
                </div>
                <h6>projects</h6>
                <hr className="mt-0 mb-4" />
